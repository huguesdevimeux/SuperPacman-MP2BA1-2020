...
public final class Transform implements Serializable {
    ...
    // Additional methods can be added if wanted:
    // scale in specific direction, according to vector etc.
    // scale using specific center of transformation etc.
    ...
    // additional degree rotation can be added if wanted:
    // 90, 180, 270 degrees rotation for example    
